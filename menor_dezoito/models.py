...
class Menor(models.Model):
    nome_responsavel = models.CharField( max_length=50,verbose_name='Nome completo do Responsavel')
    ...
    nome_menor = models.CharField(max_length=50, verbose_name='Nome completo do menor')
